...
void orbis::syscall_entry(Thread *thread) {
  ...
  if (syscall_num >= p->sysent->size) {
    ...
    if (sysent.narg > regcnt) {
      ...
      error = int(uread(args + regcnt, ptr<void>(readRegister(thread->context, RegisterId::rsp) + sizeof(uint64_t)),
...
static const std::unordered_map<SysResult (*)(Thread *, uint64_t *), const char *> gImplToName = {
  ...
  {wrap<sys_sctp_generic_sendmsg_iov>().call, "sys_sctp_generic_sendmsg_iov"},
  ...
  {wrap<sys_query_memory_protection>().call, "sys_query_memory_protection"},
  ...
  {wrap<sys_dynlib_do_copy_relocations>().call, "sys_dynlib_do_copy_relocations"},
  ...
  {wrap<sys_dynlib_process_needed_and_relocate>().call, "sys_dynlib_process_needed_and_relocate"},
  ...
  {wrap<sys_get_paging_stats_of_all_threads>().call, "sys_get_paging_stats_of_all_threads"},
  {wrap<sys_get_proc_type_info>().call, "sys_get_proc_type_info"},
  {wrap<sys_get_resident_count>().call, "sys_get_resident_count"},
  {wrap<sys_prepare_to_suspend_process>().call, "sys_prepare_to_suspend_process"},
  {wrap<sys_get_resident_fmem_count>().call, "sys_get_resident_fmem_count"},
  {wrap<sys_thr_get_name>().call, "sys_thr_get_name"},
  {wrap<sys_set_gpo>().call, "sys_set_gpo"},
  {wrap<sys_get_paging_stats_of_all_objects>().call, "sys_get_paging_stats_of_all_objects"},
  ...
  {wrap<sys_extend_page_table_pool2>().call, "sys_extend_page_table_pool2"},
  {wrap<sys_get_kernel_mem_statistics>().call, "sys_get_kernel_mem_statistics"},
  {wrap<sys_get_sdk_compiled_version>().call, "sys_get_sdk_compiled_version"},
  {wrap<sys_app_state_change>().call, "sys_app_state_change"},
  {wrap<sys_dynlib_get_obj_member>().call, "sys_dynlib_get_obj_member"},
  {wrap<sys_budget_get_ptype_of_budget>().call, "sys_budget_get_ptype_of_budget"},
  {wrap<sys_prepare_to_resume_process>().call, "sys_prepare_to_resume_process"},
  ...
  {wrap<sys_dynlib_get_info_for_libdbg>().call, "sys_dynlib_get_info_for_libdbg"},
  ...
  {wrap<sys_dynlib_get_list_for_libdbg>().call, "sys_dynlib_get_list_for_libdbg"},
  ...
  {wrap<sys_get_ppr_sdk_compiled_version>().call, "sys_get_ppr_sdk_compiled_version"},
  ...
  {wrap<sys_acinfo_get_all_for_coredump>().call, "sys_acinfo_get_all_for_coredump"},
...
constinit sysentvec freebsd9_sysvec = {
  .size = std::size(freebsd9_sysent),
  .table = freebsd9_sysent
};

constinit sysentvec freebsd11_sysvec = {
  .size = std::size(freebsd11_sysent),
  .table = freebsd11_sysent
};

constinit sysentvec ps4_sysvec = {
  .size = std::size(ps4_sysent),
  .table = ps4_sysent
};

constinit sysentvec ps5_sysvec = {
  .size = 0,
  .table = nullptr
};
} // namespace orbis
